                    ...
                    {filtered.map((user) => (
                      <tr key={user.Id}>
                        ...
                        <td className="personasTableActions">
                          ...
                          <button type="button" className="personasTableLink" onClick={() => openResetPassword(user)}>
                            Reset pass
                          </button>
                          <button type="button" className="personasTableLink" onClick={() => void handleToggleActive(user)}>
  ...
  function renderUserFormFields(): React.JSX.Element {
    return (
      <>
        ...
        <label className="personasField personasFieldInline">
